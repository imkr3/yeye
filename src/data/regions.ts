...
export const REGIONS: Record<string, RegionConfig> = {
  "sunken-corridor": {
    ...
    npcs: [{ id: "isra", label: "이스라", x: 250, y: 420, color: 0x4c6e5c, shape: "leaf", dialogue: israDialogue }],
  ...
  "frost-observatory": {
    ...
    npcs: [{ id: "helga", label: "헬가 도른", x: 480, y: 400, color: 0xa8873a, shape: "triangle", dialogue: helgaDialogue }],
